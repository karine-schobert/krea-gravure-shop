 ...
 */
final class Version20260321153739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(120) NOT NULL, slug VARCHAR(140) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, image VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_64C19C15E237E06 (name), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB');
        $this->addSql('CREATE TABLE homepage (id INT AUTO_INCREMENT NOT NULL, hero_eyebrow VARCHAR(100) NOT NULL, hero_title VARCHAR(255) NOT NULL, hero_description LONGTEXT NOT NULL, hero_primary_cta_label VARCHAR(100) NOT NULL, hero_primary_cta_link VARCHAR(255) NOT NULL, hero_secondary_cta_label VARCHAR(100) NOT NULL, hero_secondary_cta_link VARCHAR(255) NOT NULL, hero_image VARCHAR(255) NOT NULL, about_title VARCHAR(255) NOT NULL, about_text1 LONGTEXT NOT NULL, about_text2 LONGTEXT NOT NULL, about_image VARCHAR(255) NOT NULL, benefits JSON NOT NULL, shop_title VARCHAR(255) NOT NULL, shop_subtitle LONGTEXT NOT NULL, shop_description LONGTEXT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB');
